            ...
            <div className="flex flex-row justify-between">
                <div className="bg-white rounded-lg p-4 w-full mr-1">
                    ...
                    <div>
                        ...
                        <div className="flex flex-row w-full">
                            <SearchableSelect label={'Type'} placeHolder={'Select Type'} setWidth="32%" options={listType} value={formData?.employeeTypeID} isDisabled={isAdd ? false : isReadOnly} />
                            <div className="mx-2" />
                            <Input readOnly={isAdd ? false : isReadOnly} setWidth="32%" label={'Basic Salary'} type={'text'} value={formatText(formData?.basicSalary)} />
                        </div>
                    </div>
                </div>
                ...
                <div className="ml-1 w-[50%]">
                    ...
                    <div className="flex flex-row justify-end">
                        <div className="flex flex-col bg-[#333333c3] min-w-[200px] rounded-l-lg">
                            ...
                            <div className="w-full p-2 bg-[#ffffff1f] border border-[#ffffff10] px-6"><p className="text-xs text-start font-semibold text-white">{`Khusus (/bln)`}</p></div>
                            <div className="w-full p-2 bg-[#ffffff1f] border border-[#ffffff10] px-6"><p className="text-xs text-start font-semibold text-white">{`Operasional (/bln)`}</p></div>
