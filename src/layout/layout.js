...
const Layout = ({ children, setAuth, contentFootet = null, isLoading = false }) => {
  ...
  const validPaths = ["/", "/report/detail", "/report", "/employee", "/employee/detail", "/employee/salaryreport", "/salaryreport", "/attendance", "/attendance/detail", "/unattendance", "/unattendance/form", "/shift", "/calculator"];
