...
const Button = ({type = 'button', setWidth = '100%', position = 'left', text = '', showBorder = false, bgcolor, color, isLoading = false, handleAction = null, icon = null, flagFilter = false, setPadding = '8px'}) => {
